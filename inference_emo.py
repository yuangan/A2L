...
F0_model = JDCNet(num_class=1, seq_len=300)
...
model_path = 'Models/A2L_M30_gn/epoch_00140.pth'

with open('Models/A2L_M30_gn/config_emo_M30.yml') as f:
...
# wav_path = '/data3/MEAD/M031/wav/neutral/level_1/004.wav'
...
#         print('infer 134 f0: ', f0_feat.shape) #torch.Size([1, 256, 10, 299])
        ...
        out, _ = starganv2.generator(source.unsqueeze(1), ref, F0=f0_feat)
        print(out.shape)
...
for key, wave in converted_samples.items():
    with open(f'./audio_result/converted_001_{key}.wav', 'wb') as f:
        ...
        if reconstructed_samples[key] is not None:
            with open(f'./audio_result/recon_{key}.wav', 'wb') as f:
