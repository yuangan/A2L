...
from models import Generator, MappingNetwork, StyleEncoder, LmkEncoder, MotDecoderTR, DiscriminatorMot
...
model_mot_path = '/home/gy/gy/benchmark/A2L_StarG2/Models/A2L_mot_M30_140/epoch_01996.pth'
...
mel_size = input_lmks.shape[1]
extend_lmks[0, :mel_size, :, :] = input_lmks
