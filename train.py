...
def main(config_path):
    ...
    # build model
    model, model_ema, model_mot = build_model(Munch(config['model_params']), F0_model, ASR_model)
    ...
    scheduler_params_dict2 = {key: scheduler_params.copy() for key in model_mot}
    # scheduler_params_dict['mapping_network']['max_lr'] = 2e-6
    optimizer2 = build_optimizer({key: model_mot[key].parameters() for key in model_mot},
