...
from meldataset_audio import build_dataloader
from optimizers import build_optimizer
from models import build_model_audio
...
def main(config_path):
    ...
    # build model
    model, model_ema = build_model_audio(Munch(config['model_params']), F0_model, ASR_model)
    ...
    scheduler_params = {
        ...
        "div_factor": float(config['optimizer_params'].get('div_factor', 1)),
        "final_div_factor": float(config['optimizer_params'].get('final_div_factor', 1)),
    }
